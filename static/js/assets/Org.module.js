(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var OrgDetails = /** @class */ (function (_super) {
        ...
        OrgDetails.prototype.componentWillReceiveProps = function (nextProps) {
    ...
    function orgReducer(state, action) {
        ...
        switch (action.type) {
            case FETCH_GITHUB_ORG_START:
                return __assign(__assign({}, state), { githubOrgLoading: true });
            case FETCH_GITHUB_ORG_DETAILS:
                return __assign(__assign({}, state), { githubOrgName: action.GithubOrgName, githubOrgLoading: false });
            case FETCH_GITHUB_ORG_DETAILS_FULFILLED:
                return __assign(__assign({}, state), { githubOrgDetails: action.GithubOrgDetails, githubOrgLoading: false });
            case FETCH_GITHUB_ORG_DETAILS_CANCEL:
                return __assign(__assign({}, state), { githubOrgLoading: false });
